...
-- Custom keymaps
vim.keymap.set('n', ',,', 'A,<Esc>', { desc = 'Place colon at end of the line.' })
vim.keymap.set('n', ';;', 'A;<Esc>', { desc = 'Place semicolon at end of the line.' })
